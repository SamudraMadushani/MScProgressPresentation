...
```{r figurechapter04, echo=FALSE, fig.align = 'center',message=FALSE, out.width = '100%', out.height = '50%',fig.height=5, fig.width=10}
knitr::include_graphics("Figures/F2.JPG")
```
...
```{r figurechapter05, echo=FALSE, fig.align = 'center',message=FALSE, out.width = '50%', out.height = '10%',fig.height=5, fig.width=10}
knitr::include_graphics("Figures/F5.JPG")
```
...
```{r figurechapter06, echo=FALSE, fig.align = 'center',message=FALSE, out.width = '70%', out.height = '10%',fig.height=5, fig.width=10}
knitr::include_graphics("Figures/F6.JPG")
```
...
knitr::include_graphics("Figures/F8.JPG")
```
...
# Time series features-Districts

```{r}
Dengue_features<-DataDengueTEST %>% features(Counts, feature_set(pkgs = "feasts"))
Dengue_features
```

---

# Excluded features from PCA - Districts
...
# Feature based visualization - Districts
...
FBVZ<-pcs %>%
    ggplot(aes(x = .fittedPC1, y = .fittedPC2, col = Province, label=Districts)) +
    geom_point() +
    theme(aspect.ratio = 1)+
    geom_text_repel(aes(label=Districts), max.overlaps = Inf)+
    labs(x="PC1", y = "PC2")

FBVZ<-FBVZ+ theme(legend.position = "bottom")
...
FBVZ1<-FBVZ1+ theme(legend.position = "bottom")
...
FBVZ2<-pcs %>%
  ...
  ggeasy::easy_center_title()
FBVZ2<-FBVZ2+ theme(legend.position = "bottom")

FBVZ3<-pcs %>%
    ggplot(aes(x = .fittedPC1, y = .fittedPC2, col = seasonal_strength_year, label=Districts))     +geom_point() +
    theme(aspect.ratio = 1)+
    geom_text_repel(aes(label=Districts), max.overlaps = Inf)+
    labs(x="PC1", y = "PC2",title = "Seasonal strength")+scale_color_viridis(option = "A")+
  ggeasy::easy_center_title()
FBVZ3<-FBVZ3+ theme(legend.position = "bottom")
(FBVZ2|FBVZ3)
...
```{r ,echo=FALSE, out.width = '100%', out.height = '100%',fig.height=10, fig.width=16}
